...
class Attacker:
    ...
    def attack_unconstrained(self, text_prompt, img, batch_size = 4, num_iter=2000, alpha=1/255):
    ...
    def attack_constrained(self, text_prompt, img, batch_size = 4, num_iter=2000, alpha=1/255, epsilon = 128/255 ):
